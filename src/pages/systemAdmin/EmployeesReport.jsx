...
//       <h1 className="text-2xl font-bold mb-6 text-gray-700">Employee Overview</h1>
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//         {/* Chart Section */}
//         <div className="bg-white rounded-lg shadow-md p-4">
//           <h2 className="text-lg font-medium mb-4 text-gray-600">Salary Distribution</h2>
...
//           <h2 className="text-lg font-medium mb-4 text-gray-600">Employee Details</h2>
